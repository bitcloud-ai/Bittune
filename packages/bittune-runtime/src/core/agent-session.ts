...
export interface AgentSessionConfig {
	...
	/** Whether an allowlist should activate every allowed Tool during registry refresh. */
	activateAllowedToolsOnRefresh?: boolean;
...
export class AgentSession {
	...
	private _activateAllowedToolsOnRefresh: boolean;
	...
	constructor(config: AgentSessionConfig) {
		...
		this._activateAllowedToolsOnRefresh = config.activateAllowedToolsOnRefresh ?? true;
		...
		this._buildRuntime({
			...
			// A catalog allowlist deliberately separates "available" from "active".
			// Preserve the legacy behavior only when callers did not opt into that mode.
			includeAllExtensionTools: this._activateAllowedToolsOnRefresh,
		});
	}
	...
	private _refreshToolRegistry(options?: { activeToolNames?: string[]; includeAllExtensionTools?: boolean }): void {
		...
		if (allowedToolNames && this._activateAllowedToolsOnRefresh) {
